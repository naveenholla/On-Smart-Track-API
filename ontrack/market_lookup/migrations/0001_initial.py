    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exchange', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='day_types', to='market_lookup.exchange')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exchange', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='indices', to='market_lookup.exchange')),
            ],
            options={
                'ordering': ['created_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='equity_indices', to='market_lookup.equity')),
                ('index', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='indices', to='market_lookup.index')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
