    ...
    def unsubscribe(self, symbol):
        ...
        if self.__ws_object is not None:
            self.__ws_object.send(
                self.__construct_send_message(symbol=symbol, unsubscribe_flag=True)
            )
        ...
        try:
            ...
            for i in range(len(msg)):
                ...
                (
                    ...
                    fyFlag,
                    pktLen,
                ) = constants.FY_P_HEADER_FORMAT.unpack(
                ...
                (
                    ...
                    mcp,
                    mv,
                ) = constants.FY_P_COMMON_7208.unpack(
                ...
                if int(fyCode) not in [7202, 7207, 27]:
                    ...
                    (
                        ...
                        totBuy,
                        totSell,
                    ) = constants.FY_P_EXTRA_7208.unpack(
                    ...
                    for i in range(0, 10):
                        prc, qty, num_ord = constants.FY_P_MARKET_PIC.unpack(
                            self.message[: constants.FY_P_LEN_BID_ASK]
                        )
            ...
            logging.error(
                f"payload_creation :: ERR : -> Line:{exc_tb.tb_lineno} Exception:{str(e)}"
            )
